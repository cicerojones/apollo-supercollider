...
#+BEGIN_SRC clojure
(remove-event-handler ::old-amp-knob2)
(remove-event-handler ::old-centerpos-knob1)
#+END_SRC
...
#+RESULTS:
: #<synth-node[loading]: user/general-tgrains 54>
...
#+RESULTS:
: #<synth-node[loading]: user/general-tgrains 55>
...
#+BEGIN_SRC clojure :results silent
(ctl general-tgrains :buffer 1 :centerpos 100)
#+END_SRC
